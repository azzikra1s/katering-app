<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-600">
            <a href="{{ route('merchant.orders') }}" class="hover:text-blue-600">Pesanan</a>
            <span>/</span>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-4 pt-4 border-t border-gray-200">
                        ...
                        <div>
                            <p class="text-xs text-gray-600">Email Kantor</p>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg border border-gray-200 p-6 space-y-4 sticky top-24">
                    ...
                    <button onclick="window.print()" class="w-full bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors py-2 text-sm">
                        Cetak Invoice
                    </button>

                    <a href="{{ route('merchant.orders') }}" class="block text-center text-gray-600 hover:text-gray-900 font-medium text-sm">
                        Kembali
                    </a>
                </div>
            </div>
